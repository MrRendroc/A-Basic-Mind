...
This repository is a BASIC bootstrap program for Linus's code. 
I didn't know how to write assembly or machine code for the C64 when I was a kid, but I could type in BASIC from a magazine, so I approached it from that angle. It's the first BASIC program I've written in probably 25 years.

First, I converted the a_mind_is_born.prg to DATA statements, then used POKE to write them to a separate part of ROM ($0801->$9F01, since $0801 would be where my magazine-listed BASIC program would start from).
...
Below is a direct copy of Mr. Akesson's documentation of his work:
------------------------------------------------------------------
https://www.linusakesson.net/scene/a-mind-is-born/index.php
How it works
